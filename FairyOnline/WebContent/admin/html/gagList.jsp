...
<head>
	...
	<script type="text/javascript">
     function before(){
    	window.location.href="${ctx}/admin/gagList?pages=${(pages<1)?pages:(pages-1)}";
    }
     function next(){
     	window.location.href="${ctx}/admin/gagList?pages=${(pages>=totalPages)?pages:(pages+1)}";
     }
	</script>
</head>
<body>
    <div class="container">
        ...
        <div class="right">
            ...
            <div class="right-middle">
                <ul>
                    <c:forEach items="${gagList}" var="gag">
                    <li>
                       <div class="right-middle-title">用户名:${gag.uid.userLogin.userName}</div>
                       <div class="right-middle-title">处理人:${gag.aName.UserName}</div>
                       <div class="right-middle-title">被举报时间:${gag.sTime}</div>
                       </div> 
                    </li>
                    </c:forEach>
               </ul>
