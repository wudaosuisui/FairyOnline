    ...
    <div class="container">
        ...
        <div class="right">
            ...
            <div class="right-middle">
                <ul>
                    <c:forEach items="${reportVideoList}" var="reportVideo">
                    <li>
                       <div class="right-middle-title">视频名:${reportVideo.rid.userLogin.userName}</div>
                       <div class="right-middle-title">被举报时间:${reportVideo.date}</div>
                       <div class="right-middle-title">
                       <!--  <button class="right-middle-btn" onclick="detail()">举报详情</button> -->
                       <a href="${ctx}/admin/reportVideoDetail?id=${reportVideo.id}">举报详情</a>
                       </div> 
                    </li>
                    </c:forEach>
               </ul>
