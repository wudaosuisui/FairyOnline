    ...
    <div class="container">
        ...
        <div class="right">
            <div class="right-top">
               ...
               <div class="title">
                    <p class="p">视频名：${rcourse.rid.userLogin.userName}</p>
                    <p class="p">举报者：${rcourse.uid.userLogin.userName}</p>
                    <p class="p">举报时间：${rcourse.date}</p>
                    <p class="p">举报详情：${rcourse.reason}</p>
                </div>
            </div>
